...
int main(void) {
    // UTF-8 Header with proper heart emoji spacing
    printf("[Magrathea] ❤  ❤  Project Member Introduction  ❤  ❤\n");
    printf("=============================================================================================\n");
    
    // Arthur Dent (15 years -> Binary + Normal Display)
    ...
    printf("---------------------------------------------------------------------------------------------\n");
    printf("Introduction | Gained experience in various projects in SNS, Fintech, HR, and Media in Silicon Valley.\n");
    printf("             | I want to share the insights I’ve learned through both successes and failures.\n");

    printf("=============================================================================================\n");
    
    // Kim Youngjin (2 years -> Binary + Normal Display)
    ...
    // Im Woncheol (1 year -> Binary + Normal Display)
    printf("Name         | Im Woncheol                               \tGender      | Male\n");
    printf("Major        | Electronic Engineering                    \tExperience  | 00000000 00000000 00000000 00000001(2) year\n");
    ...
    // Yoo Goeun (1 year -> Binary + Normal Display)
    printf("Name         | Yoo Goeun                                 \tGender      | Female\n");
    printf("Major        | Management Information Systems             \tExperience  | 00000000 00000000 00000000 00000001(2) year\n");
    ...
    // Seo Hyekyung (0 years -> Binary + Normal Display)
